...
> Methodology and F# reference: workspace `CLAUDE.md` and `FSHARP.md` (one level up).
> Library sync contract: when `EVENT_MODELING.md` changes, update `## Event Modeling` in workspace `CLAUDE.md`.
